...
// Address marker: a free (non-member) function in this translation unit whose
// address can be passed to GetModuleHandleExA with
// GET_MODULE_HANDLE_EX_FLAG_FROM_ADDRESS so that Windows resolves the HMODULE
// for this DLL/EXE.  A pointer-to-member-function may NOT be used for that
// purpose (C2276 / C2660 on MSVC).
static void DotNetAdapterModuleMarker() {}
